...
do -- Library
    ...
    function GamesenseLib:Window(Options)
        ...
        function Window:CreateTab(Options)
            ...
            --
            local Inline_1 = GamesenseLib:CreateObject("Frame", {
            ...
            --
            local Main = GamesenseLib:CreateObject("Frame", {
                Size = UDim2.new(1, 1, 1, -2),
                Name = "Main",
                Position = UDim2.new(0, 0, 0, 1),
                BorderColor3 = Color3.fromRGB(0, 0, 0),
            ...
            --
            local Pattern_1 = GamesenseLib:CreateObject("ImageLabel", {
                ImageColor3 = Color3.fromRGB(12, 12, 12),
                ScaleType = Enum.ScaleType.Tile,
                BorderColor3 = Color3.fromRGB(0, 0, 0),
                Name = "Pattern_1",
            ...
            --
            local Button = GamesenseLib:CreateObject("TextButton", {
            ...
            --
            local Icon = GamesenseLib:CreateObject("ImageLabel", {
                BorderColor3 = Color3.fromRGB(0, 0, 0),
                Name = "Button",
                Image = Options.Icon,
                BackgroundTransparency = 1,
            ...
            --
            local SectionsHolder = GamesenseLib:CreateObject("Frame", {
                Name = "SectionsHolder",
                BackgroundTransparency = 1,
                Visible = true,
            ...
            --
            local Left = GamesenseLib:CreateObject("Frame", {
                BackgroundTransparency = 1,
                Name = "Left",
                BorderColor3 = Color3.fromRGB(0, 0, 0),
                Size = UDim2.new(0.5, 0, 1, 0),
            ...
            --
            local UIPadding_1 = GamesenseLib:CreateObject("UIPadding", {
            ...
            --
            local UIListLayout12 = GamesenseLib:CreateObject("UIListLayout", {
                Padding = UDim.new(0, 19),
                SortOrder = Enum.SortOrder.LayoutOrder,
                Parent = Left
            })
            --
            local Right = GamesenseLib:CreateObject("Frame", {
                Name = "Right",
                BackgroundTransparency = 1,
            ...
            --
            local UIPadding_2 = GamesenseLib:CreateObject("UIPadding", {
                PaddingTop = UDim.new(0, 19),
                PaddingBottom = UDim.new(0, 19),
            ...
            --
            local UIListLayout52 = GamesenseLib:CreateObject("UIListLayout", {
                Padding = UDim.new(0, 19),
                SortOrder = Enum.SortOrder.LayoutOrder,
                Parent = Right
            })
            --
            local SectionsHolder2 = GamesenseLib:CreateObject("Frame", {
                Name = "SectionsHolder",
                BackgroundTransparency = 1,
                Visible = true,
                Position = UDim2.new(0, 76, 0, 5),
            ...
            --
            local SubSectionHolder = GamesenseLib:CreateObject("Frame", {
            ...
            do -- Functions
                function Tab:MoveSides(State)
                    task.spawn(function()
                        if State then
                            ...
                            --
                            GamesenseLib:TweenObject(SubSectionHolder, TweenInfo.new(GamesenseLib.UI.TweenSpeed, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Position = UDim2.new(0, 21, 0, 19)})
                            GamesenseLib:TweenObject(Left, TweenInfo.new(GamesenseLib.UI.TweenSpeed, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Position = UDim2.new(0, 0, 0, 0)})
                            GamesenseLib:TweenObject(Right, TweenInfo.new(GamesenseLib.UI.TweenSpeed, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Position = UDim2.new(0.5, 1, 0, 0)})
                        else
                            task.wait(0.001)
                            --
                            ...
                            --
                            GamesenseLib:TweenObject(SubSectionHolder, TweenInfo.new(GamesenseLib.UI.TweenSpeed, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Position = UDim2.new(0, 21, 0, SubSectionPosition)})
                            GamesenseLib:TweenObject(Left, TweenInfo.new(GamesenseLib.UI.TweenSpeed, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Position = UDim2.new(0, 0, 0, LeftPosition)})
                            GamesenseLib:TweenObject(Right, TweenInfo.new(GamesenseLib.UI.TweenSpeed, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Position = UDim2.new(0.5, 1, 0, RightPosition)})
                        end
                    end)
                end
                --
                function Tab:Activate()
                    if not Tab.Active then
                        ...
                        Tab:MoveSides(true)
                        --
                        GamesenseLib:TweenObject(Icon, TweenInfo.new(GamesenseLib.UI.TweenSpeed, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(210, 210, 210)})
                ...
                function Tab:Deactivate()
                    if Tab.Active then
                        ...
                        GamesenseLib:TweenObject(Icon, TweenInfo.new(GamesenseLib.UI.TweenSpeed, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(90, 90, 90)})
                        --
                        Tab:MoveSides(false)
                    end
                end
            ...
            --
            do -- Connections
                GamesenseLib:Connection(Outline:GetAttributeChangedSignal("g"), function()
                ...
                --
                GamesenseLib:Connection(Outline:GetPropertyChangedSignal("AbsoluteSize"), function()
                    if not Tab.Active then
                        SubSectionHolder.Position = UDim2.new(0, 21, 0, SectionsHolder2.AbsoluteSize.Y + SubSectionHolder.AbsoluteSize.Y)
                        Left.Position = UDim2.new(0, 0, 0, Left.AbsoluteSize.Y)
                        Right.Position = UDim2.new(0.5, 1, 0, Right.AbsoluteSize.Y)
                ...
                --
                GamesenseLib:Connection(Button.MouseButton1Click, function()
                    Tab:Activate()
                end)
                --
                GamesenseLib:Connection(TabActive.MouseEnter, function()
                    if not Tab.Active then
                        Tab.Hovering = true
                        GamesenseLib:TweenObject(Icon, TweenInfo.new(GamesenseLib.UI.TweenSpeed, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(168, 168, 168)})
                    end
                end)
                --
                GamesenseLib:Connection(TabActive.MouseLeave, function()
                    if not Tab.Active then
                        Tab.Hovering = false
                        GamesenseLib:TweenObject(Icon, TweenInfo.new(GamesenseLib.UI.TweenSpeed, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(90, 90, 90)})
                    end
            ...
            function Tab:Section(Options)
                ...
                --
                local SectionOutline = GamesenseLib:CreateObject("Frame", {
                    Name = "SectionOutline",
                    BorderColor3 = Color3.fromRGB(0, 0, 0),
                    Size = UDim2.new(1, 0, 0, Options.Size),
                ...
                --
                local SectionInline = GamesenseLib:CreateObject("Frame", {
                    Name = "SectionInline",
                    Position = UDim2.new(0, 1, 0, 1),
                    BorderColor3 = Color3.fromRGB(0, 0, 0),
                    Size = UDim2.new(1, -2, 1, -2),
                ...
                --
                local SectionScrolling = GamesenseLib:CreateObject("ScrollingFrame", {
                    ScrollBarImageColor3 = Color3.fromRGB(65, 65, 65),
                    MidImage = "rbxassetid://158362264",
                    Active = true,
                    BorderColor3 = Color3.fromRGB(0, 0, 0),
                ...
                --
                local UIListLayout_3 = GamesenseLib:CreateObject("UIListLayout", {
                ...
                --
                local SectionMain = GamesenseLib:CreateObject("Frame", {
                    Size = UDim2.new(1, -2, 1, -2),
                    Name = "SectionMain_1",
                    Position = UDim2.new(0, 1, 0, 1),
                    BorderColor3 = Color3.fromRGB(0, 0, 0),
                ...
                --
                local SectionFader = GamesenseLib:CreateObject("Frame", {
                    Size = UDim2.new(1, 0, 0, 20),
                    AnchorPoint = Vector2.new(0, 1),
                    Name = "SectionFader",
                    Position = UDim2.new(0, 0, 1, 0),
                ...
                --
                local SectionFader2 = GamesenseLib:CreateObject("Frame", {
                    Size = UDim2.new(1, 0, 0, 20),
                    Name = "SectionFader",
                    Position = UDim2.new(0, 0, 0, 0),
                    BorderColor3 = Color3.fromRGB(0, 0, 0),
                ...
                --
                local TitleInline = GamesenseLib:CreateObject("Frame", {
                    BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                    BackgroundTransparency = 0,
                    BorderColor3 = Color3.fromRGB(0, 0, 0),
                    Name = "TitleInline",
                ...
                --
                local UIGradient2 = GamesenseLib:CreateObject("UIGradient", {
                    Rotation = 90,
                    Color = ColorSequence.new{
                ...
                --
                local Title = GamesenseLib:CreateObject("TextButton", {
                    AnchorPoint = Vector2.new(0, 0.5),
                    BackgroundColor3 = Color3.fromRGB(0, 0, 0),
                    BackgroundTransparency = 1,
                    BorderColor3 = Color3.fromRGB(0, 0, 0),
                ...
                --
                local ResizableButton_6 = GamesenseLib:CreateObject("ImageButton", {
                ...
                do -- Functions
                    ...
                    function Section:CalculateButton(Position)
                        ...
                        --
                        local ButtonMain = GamesenseLib:CreateObject("Frame", {
                            Size = UDim2.new(1, -2, 1, -2),
                            Name = "SectionMain_1",
                            Position = UDim2.new(0, 1, 0, 1),
                            BorderColor3 = Color3.fromRGB(0, 0, 0),
                        ...
                        --
                        local ButtonText = GamesenseLib:CreateObject("TextLabel", {
                            AnchorPoint = Vector2.new(0, 0.5),
                            BackgroundColor3 = Color3.fromRGB(0, 0, 0),
                            BackgroundTransparency = 1,
                            BorderColor3 = Color3.fromRGB(0, 0, 0),
